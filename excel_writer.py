...
COLUMN_TO_CELL_COORDINATE_MAP = {
    ...
    "goal_p_residence_slct": ("様式23_1", "E3"),
    "goal_p_return_to_work_status_slct": ("様式23_1", "E5"),
    ...
    "nutrition_swallowing_diet_code_txt": ("様式23_1", "X62"),
    ...
    "func_rom_limitation_chk": ("様式23_1", "Z12"),
